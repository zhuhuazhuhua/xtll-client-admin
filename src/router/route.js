      ...
      children: [
        {
          ...
          component: () => import('src/pages/home/identity')
        },
        {
          path: 'power',
          name: 'power',
          ...
          component: () => import('src/pages/home/power')
        },
        {
          path: 'goods',
          name: 'goods',
          ...
          component: () => import('src/pages/home/goods')
        },
        {
          path: 'goods-detail',
          name: 'goods-detail',
          ...
          component: () => import('src/pages/home/goods-detail/goods-detail')
        },
        {
          path: 'set',
          name: 'set',
